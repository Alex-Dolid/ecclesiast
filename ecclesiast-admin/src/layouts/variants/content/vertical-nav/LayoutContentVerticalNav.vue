<template>
  <layout-content-vertical-nav-core :nav-menu-items="navMenuItems">
    <slot></slot>
      ...
      >
        ...
        <div class="d-flex align-center">
          ...
          <app-bar-search
            ...
            @update:shallShowFullSearch="handleShallShowFullSearchUpdate(
  ...
  </layout-content-vertical-nav-core>
</template>
...
// @Core Layouts
import LayoutContentVerticalNavCore from '@core/layouts/variants/content/vertical-nav/LayoutContentVerticalNav';
...
export default {
  ...
  setup() {
    ...
    // ? Handles case where in <lg vertical nav menu is open and search is triggered using hotkey
    // then searchbox is hidden behind vertical nav menu overlaty
