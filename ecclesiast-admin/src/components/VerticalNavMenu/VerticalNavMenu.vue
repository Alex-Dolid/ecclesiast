...
// Components
import { NavMenuSectionTitle, NavMenuGroup, NavMenuLink } from './components';
...
// ? Adjust this `translateX` value to keep logo in center
// when vertical nav menu is collapsed (Value depends on your logo)
.app-logo {
